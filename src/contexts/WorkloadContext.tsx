...
function WorkloadProvider({ children }: WorkloadProviderProps) {
  ...
  const updateSlot = useCallback(
    (index: number, updates: Partial<WorkloadSlot>) => {
  ...
  const setSlotWorkload = useCallback(
    (index: number, workload: Workload | null) => {
  ...
  const setSlotPercentage = useCallback(
  ...
  const getSlotById = useCallback(
    (id: string): WorkloadSlot | undefined => {
